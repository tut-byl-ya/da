...
define config.name = _("Чайные истории из жизни")
...
define gui.about = _p("""Мы маленькая команда разработчиков Nebufari, которая создает новелы с огромной страстью. Наша цель как разработчков - погрузить читателей в захватывающие миры, интригующими сюжетами и эмоциональной глубиной.
""")
...
define config.save_directory = "Chainieistoriiizzhizni-1691997104"
